...
public class CalorieTrackerCLI {
    ...
    private void setupUser() {
        ...
        while (!gender.equals("male") && !gender.equals("female")) {
            System.out.print(Colors.RED + "Invalid input. Enter gender (male/female): " + Colors.RESET);
    ...
    private void displayMainMenu() {
        ...
        // String calorieColor = Colors.colorizeCalories(consumedCalories, targetCalories);
        
        System.out.println("\n" + Colors.CYAN_BOLD + "===== Main Menu =====" + Colors.RESET);
        // System.out.println(Colors.BLUE + "Date: " + Colors.YELLOW_BOLD + currentDate.format(DateTimeFormatter.ISO_DATE) + Colors.RESET);
        // System.out.println(Colors.BLUE + "Calculator: " + Colors.WHITE + controller.getCurrentCalculatorName() + Colors.RESET);
        // System.out.println(Colors.BLUE + "Target Calories: " + Colors.WHITE + targetCalories + Colors.RESET);
        // System.out.println(Colors.BLUE + "Consumed Calories: " + calorieColor + consumedCalories + Colors.RESET);
        
        // Display difference with color based on value
        // if (difference < 0) {
        //     System.out.println(Colors.BLUE + "Difference: " + Colors.RED_BOLD + difference + " (exceeded)" + Colors.RESET);
        // } else {
        //     System.out.println(Colors.BLUE + "Difference: " + Colors.GREEN_BOLD + difference + " (remaining)" + Colors.RESET);
        // }
        
        System.out.println("\n" + Colors.YELLOW_BOLD + "Menu Options:" + Colors.RESET);
        System.out.println(Colors.WHITE_BOLD + "1." + Colors.WHITE + " Search Foods/Add Food to Today's Log" + Colors.RESET);
        ...
        System.out.println(Colors.WHITE_BOLD + "0." + Colors.RED + " Exit" + Colors.RESET);
    }
    ...
    //     System.out.println("\n" + Colors.CYAN_BOLD + "==== Add Food to Log ====" + Colors.RESET);
        
    //     // Search for food
    //     System.out.print(Colors.BLUE + "Enter search term for food: " + Colors.RESET);
    ...
    //         System.out.printf(Colors.WHITE_BOLD + "%d. " + Colors.GREEN + "%s " + Colors.WHITE + "(%.2f calories per serving)\n" + Colors.RESET,
    ...
    //     System.out.printf(Colors.GREEN_BOLD + "Added %.1f serving(s) of %s to the log.\n" + Colors.RESET, 
    ...
    private void viewFoodLog() {
        ...
        for (int i = 0; i < entries.size(); i++) {
            ...
            System.out.printf(Colors.WHITE_BOLD + "%d. " + Colors.GREEN + "%s " + Colors.WHITE + "- %.1f serving(s) - " + 
    ...
    private void updateFoodLog() {
        ...
        if (entries.isEmpty()) {
            System.out.println(Colors.YELLOW + "No entries for this day." + Colors.RESET);
            System.out.println("\n" + Colors.BLUE_BOLD + "To add food entries, please use 'Search Foods/Add Food to Log' from the main menu." + Colors.RESET);
        ...
        System.out.println(Colors.WHITE_BOLD + "1." + Colors.RED + " Remove a food entry" + Colors.RESET);
            ...
            case 2:
                ...
                if (entryIndex >= 0) {
                    ...
                    double newServings = getDoubleInput(
                        String.format("Enter new servings for " + Colors.GREEN + "%s" + Colors.RESET + " (current: %.1f): ", 
    ...
    private void searchFoods() {
        ...
        switch (choice) {
            ...
            case 2:
                ...
                System.out.println("\n" + Colors.PURPLE_BOLD + "-- Composite Foods Matching \"" + searchTerm + "\" --" + Colors.RESET);
        ...
        while (stayInFoodMenu && !foods.isEmpty()) {
            System.out.println("\n" + Colors.YELLOW_BOLD + "Options:" + Colors.RESET);
            System.out.println(Colors.WHITE_BOLD + "1." + Colors.WHITE + " View details of a specific food" + Colors.RESET);
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    controller.addFoodEntry(selectedFood, servings);
                    System.out.printf(Colors.GREEN_BOLD + "Added %.1f serving(s) of %s to today's log.\n" + Colors.RESET, 
                                   servings, selectedFood.getName());
                    ...
                    System.out.println(Colors.WHITE_BOLD + "2." + Colors.RED + " No, return to main menu" + Colors.RESET);
    ...
    private void displayFoodDetails(Food food) {
        ...
        System.out.println(Colors.BLUE + "Calories per serving: " + Colors.WHITE + food.getCaloriesPerServing() + Colors.RESET);
        System.out.println(Colors.BLUE + "Keywords: " + Colors.PURPLE + String.join(", ", food.getKeywords()) + Colors.RESET);
    ...
    private void changeDate() {
        ...
        System.out.println(Colors.BLUE + "Current date: " + Colors.YELLOW_BOLD + controller.getCurrentDate() + Colors.RESET);
    ...
    private void updateUserInfo() {
        ...
        System.out.println(Colors.WHITE_BOLD + "0." + Colors.BLUE + " Back to main menu" + Colors.RESET);
    ...
    private void changeCalorieCalculator() {
        ...
        System.out.println(Colors.BLUE + "Current calculator: " + Colors.YELLOW_BOLD + controller.getCurrentCalculatorName() + Colors.RESET);
    ...
    private void viewNutritionalSummary() {
        ...
        System.out.println(Colors.BLUE + "Date: " + Colors.YELLOW_BOLD + summaryDate.format(DateTimeFormatter.ISO_DATE) + Colors.RESET);
